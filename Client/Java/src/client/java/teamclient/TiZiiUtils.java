...
public class TiZiiUtils {
	 ...
	 */
	public static void BFS(Integer itemId, TiZiiCoords s, TreeMap[][] bfsTable, boolean isClearing) {
	...
	public static Direction cellToCellDirection(Cell c1, Cell c2) {
		if (c1.getRowNumber() == c2.getRowNumber() && c1.getColumnNumber() > c2.getColumnNumber())
			return Direction.LEFT;
		if (c1.getRowNumber() == c2.getRowNumber() && c1.getColumnNumber() < c2.getColumnNumber())
			return Direction.RIGHT;
		if (c1.getColumnNumber() == c2.getColumnNumber() && c1.getRowNumber() > c2.getRowNumber())
